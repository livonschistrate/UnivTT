...
$_SESSION['public_orare_sala_id'] = $_POST['public_orare_sala_id'];
$_SESSION['public_orare_sala_an_scolar'] = $_POST['public_orare_sala_an_scolar'];
$_SESSION['public_orare_sala_semestru'] = $_POST['public_orare_sala_semestru'];
...
$sql = "SELECT o.ziua, o.ora, o.sapt, o.id AS id_orar, o.ore, o.orar_id AS id_orar_master, o.orar_id_curs AS id_orar_curs_master, 
                ...
                WHERE 
                d.an_scolar=" . f($_SESSION['public_orare_sala_an_scolar']) . " AND d.semestru=" . f($_SESSION['public_orare_sala_semestru']) . "
                AND o.sali_id=".f($_SESSION['public_orare_sala_id'])."
                AND o.orar_id_curs=0 AND o.orar_id=0                
                ORDER BY ziua, ora, sapt;";
$response['sql'] = $sql;
$orar_db = $db->query($sql)->fetchAll(PDO::FETCH_ASSOC );

if ($_SESSION['public_orare_sala_id']==0) {
    $html = '<div class="mesaj-fara-orar"><i class="fa fa-calendar-days mb-3" style="color:#a0a0a0;font-size:2em;"></i><br>Alegeți o sală și un semestru din listele de mai sus pentru a vizualiza orarele.</div>';
} else {
